                ...
                <div className="mt-6 text-center font-bold">
                    ...
                    <div className="mt-8">
                        <div className="ml-4 mr-4">
                            ...
                            <input maxLength={100} value={newQuizName} onChange={(e)=>setNewQuizName(e.target.value)} type="text" className="bg-(--input-back) text-(--input-fore) pl-2 w-full h-10 md:mb-6 mb-3 rounded-lg" />
                        </div>
                        <div className="ml-4 mr-4">
